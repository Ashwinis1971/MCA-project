...
const Chatbot = () => {
  ...
  const sendMessage = async () => {
    ...
    // Check if the input is a conversational phrase
    if (conversationalResponses[normalizedInput]) {
      const userMessage = { role: 'user', text: input };
      const botMessage = { role: 'bot', text: conversationalResponses[normalizedInput] };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 animate-gradient-x bg-cover p-6">
      <div className="chatbot-container p-8 bg-white bg-opacity-90 border border-gray-300 rounded-2xl max-w-3xl w-full mx-auto shadow-2xl">
        ...
        <h1 className="text-4xl font-bold mb-8 text-center text-indigo-800 animate-pulse flex justify-center items-center">
      TurBot <FaRobot className="ml-2" />
    </h1>
